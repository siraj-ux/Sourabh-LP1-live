...
const HeroSection = () => {
  ...
  // Dates and payment link fallback
  ...
  return (
    <section className="relative min-h-0 flex flex-col items-center bg-[#0047AB] overflow-hidden px-4 py-2 md:py-12">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center text-white w-full">
        ...
        {/* Rating Image */}
        <div className="flex justify-center mb-3 md:mb-12 px-4">
        ...
        <div className="flex flex-col items-center gap-3 md:gap-10 w-full">
          ...
          <div className="w-full max-w-lg bg-white/10 backdrop-blur-xl rounded-[1.5rem] md:rounded-[2rem] p-3 md:p-8 border border-white/10 shadow-2xl">
            <div className="mb-2 md:mb-4">
              <h3 className="text-sm md:text-2xl font-bold mb-0.5">
                {formatDateWithSuffix(day1)} & {formatDateWithSuffix(day2)}
              </h3>
              <p className="text-[9px] md:text-sm opacity-90 uppercase tracking-wider">
            ...
            <Button 
              ...
              className="w-full bg-[#FF8C00] hover:bg-[#e67e00] text-sm md:text-xl font-black py-4 md:py-7 rounded-xl md:rounded-2xl shadow-lg transition-all active:scale-95 mb-1 uppercase"
            >
              BOOK NOW — Sirf 41 Seats!
            </Button>
            
            <p className="text-[8px] md:text-[10px] font-bold tracking-widest uppercase opacity-70 mb-2 md:mb-5">
              Full Hone Par Booking Band!
            </p>

            {/* REDUCED SIZE TIMER */}
            <div className="flex justify-center items-center gap-3 md:gap-8 border-t border-white/10 pt-2 md:pt-4">
